...
def main():
    ...
    # optimizer setup
    optimizer = train_utils.setup_optimizer(hypes, model_without_ddp, is_pre_trained)
    ...
    if run_test:
        ...
        cmd = f"python opencood/tools/inference.py --model_dir {saved_path} --fusion_method {fusion_method} --two_stage 1"
