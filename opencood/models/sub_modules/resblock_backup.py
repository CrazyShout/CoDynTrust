...
class ResNetModified(nn.Module):
    ...
    def __init__(
        ...
        norm_layer: Optional[Callable[..., nn.Module]] = None # 标准化的层类型
    ) -> None:
        ...
        self.layer1 = self._make_layer(block, num_filters[0], layers[0], stride=layer_strides[0]) # 输入 BasicBlock，64， 3， 2
        self.layer2 = self._make_layer(block, num_filters[1], layers[1], stride=layer_strides[1], # 输入 BasicBlock，128， 4， 2， False
                                       dilate=replace_stride_with_dilation[0])
        self.layer3 = self._make_layer(block, num_filters[2], layers[2], stride=layer_strides[2], # 输入 BasicBlock，256， 5， 2， False
