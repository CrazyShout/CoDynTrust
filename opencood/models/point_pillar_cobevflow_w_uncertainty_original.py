...
class PointPillarCobevflowWUncertaintyOriginal(nn.Module):
    def __init__(self, args):
        super(PointPillarCobevflowWUncertaintyOriginal, self).__init__()
    ...
    def forward(self, data_dict, dataset=None):
        ...
        if self.inference_state is True:
            ...
            unc_epi_cls = calc_deviation_ratio(unc_epi_cls, cls_score, tp_cls_mean = 0.8112, tp_cls_std = 0.1690, tp_score_mean = 0.6652, tp_score_std = 0.1811) # 计算分类偏差比
