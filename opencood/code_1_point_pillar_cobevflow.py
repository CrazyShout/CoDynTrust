...
class PointPillarWhere2commFlowTwoStageWDir(nn.Module):
    def __init__(self, args):
        ...
        if 'with_compensation' in args and args['with_compensation']: # 这个表示什么，是否已经补偿？似乎不涉及流flow 盲猜是单车自己跑实验
            self.compensation = True
            if 'with_single_supervise' in args and args['with_single_supervise']: # 单车自己跑
